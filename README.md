...
, using one identical harness design for both
...
- **Both harnesses are structurally identical**: same iteration count (50,000, +100
  ...
  CSV schema — this is what makes the two result sets comparable.
