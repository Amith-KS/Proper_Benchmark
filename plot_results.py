...
ax.set_title("ML-KEM-512 Keygen: mlkem-native vs PQClean")
ax.legend()
...
# --- Chart 2: code size comparison (Unchanged) ---
...
ax.grid(axis='y', linestyle='--', alpha=0.5)
plt.title("Keygen Timing Distribution (N=5000, outliers hidden)")
plt.tight_layout()
plt.savefig("results/distribution_boxplots.png", dpi=150)
plt.close()

print("Charts saved for Keygen only.")
